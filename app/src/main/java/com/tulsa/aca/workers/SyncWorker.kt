...
class SyncWorker(
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        ...
        return@withContext try {
            ...
            if (activosResult.isSuccess) {
                ...
                Log.w(TAG, "Error sincronizando activos: ${activosResult.exceptionOrNull()?.message}")
            }
            ...
            if (plantillasResult.isSuccess) {
                ...
                Log.w(TAG, "Error sincronizando plantillas: ${plantillasResult.exceptionOrNull()?.message}")
            }
            ...
            if (reportesResult.isSuccess) {
                ...
                Log.w(TAG, "Error sincronizando reportes: ${reportesResult.exceptionOrNull()?.message}")
            }
            ...
            // Reintenta con backoff exponencial hasta MAX_RETRY_ATTEMPTS; después marca como fallido
    ...
    companion object {
        ...
        fun schedulePeriodic(context: Context) {
            ...
            // KEEP evita duplicar el job si la app se reinicia mientras ya estaba programado
