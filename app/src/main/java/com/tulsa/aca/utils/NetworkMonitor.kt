 ...
 * Proporciona un Flow que emite true cuando hay conexión y false cuando no la hay
 */
class NetworkMonitor(private val context: Context) {
    ...
    /**
     * Verifica si hay conexión a Internet en este momento (sincrónico)
     */
